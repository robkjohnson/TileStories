import "./chunk-OCWROFHE.js";
import {
  createFilter$1,
  require_node_module
} from "./chunk-NZO2RSS2.js";
...
async function loadBabel() {
  if (!babel) {
    babel = await import("./lib-VIJYGALG.js");
  }
  return babel;
}
...
function viteReact(opts = {}) {
  var _a;
  let devBase = "/";
  const filter = createFilter$1(opts.include ?? defaultIncludeRE, opts.exclude);
